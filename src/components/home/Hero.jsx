                ...
                <div className="max-w-3xl text-center text-white space-y-4 md:space-y-6">
                  ...
                  <div className="flex items-center justify-center pt-1 md:pt-2">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2.5 md:gap-3 rounded-xl bg-[#941865] px-5 py-2.5 md:px-7 md:py-3.5 text-xs md:text-base font-medium text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:bg-[#7d1455]"
                    >
                      Book Appointment
