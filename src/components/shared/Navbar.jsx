          ...
          {!user ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="text-sm font-medium text-white rounded-lg py-2 px-5 transition-opacity hover:opacity-90 cursor-pointer"
                style={{ backgroundColor: "#941865" }}
              >
                Logout
              </button>
            ...
            <div className="pt-3 flex flex-col gap-2">
              {!user ? (
                ...
                <div className="flex flex-col gap-3 pt-2">
                  ...
                  <button
                    onClick={handleLogout}
                    className="w-full text-center text-sm font-medium text-white rounded-lg py-2.5 transition-opacity hover:opacity-90"
                    style={{ backgroundColor: "#941865" }}
                  >
                    Logout
                  </button>
